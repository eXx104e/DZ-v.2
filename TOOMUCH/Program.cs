...
class Program
{
    static void Main(string[] args)
    {
        ...
        Bank info = new Bank(210011349, "Сберегательный", "40000000");
        info.Print();

        Console.WriteLine("ДЗ 3.1");
        Worker worker1 = new Worker("Иван Иванов", (int)Unis.kai);
        worker1.Print1();
        Worker worker2 = new Worker("Иван Петров", (int)Unis.khti);
        worker2.Print1();
        Worker worker3 = new Worker("Иван Козлов", (int)Unis.kgu);
        worker3.Print1();
